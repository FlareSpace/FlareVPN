...
object RuOnboardingStrings : OnboardingStrings {
    ...
    override val onboarding_battery_desc : String = "Чтобы приложение работало стабильно и Android его не закрывал, нужно отключить экономию энергии для Flare."
    override val onboarding_battery_title : String = "Энергопотребление"
    override val onboarding_btn_go_main : String = "На главную"
    override val onboarding_fragmentation_desc : String = "Фрагментация помогает разделить пакет на несколько частей, что помогает обходить блокировки (DPI)."
    ...
    override val onboarding_notifications_desc : String = "Уведомления нужны, чтобы приложение работало в фоне 24/7, а также чтобы видеть актуальный статус туннеля."
    ...
    override val onboarding_split_black_desc : String = "Всё работает через прокси, кроме выбранных сайтов и приложений."
...
object EnOnboardingStrings : OnboardingStrings {
    ...
    override val onboarding_welcome_question : String = "Do you want to run the initial setup?"
    ...
    override val onboarding_split_white_header : String = "Whitelist: What will work through the proxy?"
    override val onboarding_split_black_header : String = "Blacklist: What will NOT work through the proxy?"
