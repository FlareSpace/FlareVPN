...
object RuServerStrings : ServerStrings {
    ...
    override val servers_protocol_xray_desc : String = "VLESS с Reality маскирует VPN-трафик под веб-трафик. Обладает высокой устойчивостью к обнаружению, обеспечивает высокую приватность и скорость."
    override val servers_protocol_xray_title : String = "VLESS с Reality"
...
object EnServerStrings : ServerStrings {
    ...
    override val servers_protocol_wireguard_title : String = "WireGuard"
    override val servers_protocol_xray_desc : String = "VLESS with Reality masks VPN traffic as web traffic. High detection resistance, provides high privacy and speed"
    override val servers_protocol_xray_title : String = "VLESS with Reality"
